...
* @Description: The RandomNumbersGenerator program generates million of random numbers and output to file. 
* Also, sorts random numbers and output to another file.
* @Author: Dipali Shah
* @Version: 1.0
* @Date: 2022-05-01 
*/
